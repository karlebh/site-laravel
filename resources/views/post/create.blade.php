<x-app-layout>
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg flex justify-center">
                <div class="px-6 py-4 text-gray-900 dark:text-gray-800 flex-1">
